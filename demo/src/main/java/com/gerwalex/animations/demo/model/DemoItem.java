...
public class DemoItem {
	...
	static {
		...
		addItem(new DemoAnimation(3, "Bounce",
		...
		addItem(new DemoAnimation(8, "Flip Horizontal To",
		...
		addItem(new DemoAnimation(10, "Flip Vertical To",
				"new FlipVerticalToAnimation(card)\n.setFlipToView(card2)\n.setInterpolator(new LinearInterpolator())\n.animate();"));
		addItem(new DemoAnimation(11, "Fold In",
				"new FoldInAnimation(card).setFolds(10)\n.setOrientation(Orientation.HORIZONTAL)\n.animate();"));
		addItem(new DemoAnimation(12, "Fold Out",
				"new FoldOutAnimation(card).setFolds(10)\n.setOrientation(Orientation.HORIZONTAL)\n.animate();"));
		addItem(new DemoAnimation(13, "Highlight", "new HighlightAnimation(card).animate();"));
		addItem(new DemoAnimation(14, "Path",
		...
		addItem(new DemoAnimation(17, "Rotate",
